	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #ddd">
				<thead>
					<tr>
						<th style="background-color: #eee; text-align: center">No
						<th style="background-color: #eee; text-align: center">Title
						<th style="background-color: #eee; text-align: center">Name
						<th style="background-color: #eee; text-align: center">Date
					</tr>
				</thead>
				<tbody>
					<%
